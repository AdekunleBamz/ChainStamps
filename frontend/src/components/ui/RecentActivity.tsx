          ...
          {activities.slice(0, 3).map((activity) => {
            ...
            return (
              <motion.div
                ...
                exit={{ opacity: 0, x: 10 }}
                className="group flex-between p-3 rounded-xl bg-white/5 border border-white/5 hover:border-primary/20 transition-all"
              >
                ...
                <a
                  ...
                  className="p-1.5 opacity-0 group-hover:opacity-100 text-primary hover:bg-primary/10 rounded-lg transition-all"
