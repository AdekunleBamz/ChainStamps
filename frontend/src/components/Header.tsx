            ...
            <ul className="flex items-center gap-6 list-none p-0 m-0">
              <li>
                <Tooltip content={
                  ...
                  <div className="network-heartbeat flex items-center bg-white/5 border border-white/10 px-3 py-1.5 rounded-full" aria-live="polite" aria-label={`Stacks Mainnet block height: ${blockHeight || 'Loading'}`} role="status" title={`Stacks Mainnet block height: `}>
