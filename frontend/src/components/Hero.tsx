  ...
  return (
    ...
    >
      ...
      <motion.div className="hero-cta flex-center gap-4" variants={ITEM_VARIANTS}>
        ...
        <a href="#hash" aria-label="Learn more about hash registry" className="cta-secondary h-14 px-8 rounded-2xl border border-border bg-white/5 backdrop-blur-md text-primary font-bold flex items-center gap-2 hover:bg-white/10 transition-all">
          Learn More
        </a>
      </motion.div>
